    ...
    <section id="recipe" className="py-28 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-2">
          <article className="glow-border rounded-2xl bg-card/80 p-6 md:p-7 grid gap-6 md:grid-cols-[minmax(0,1fr)_minmax(0,240px)]">
            <div>
            ...
            <div className="rounded-2xl border border-border bg-background/40 p-4 grid grid-cols-3 gap-3 place-items-center">
              {referralLogos.map((logo) => (
                <div
                  key={logo.alt}
                  className="h-12 w-full rounded-xl bg-background/70 border border-border/70 grid place-items-center"
                >
                  <Image
                    src={logo.src}
                    alt={logo.alt}
          ...
          <article className="glow-border rounded-2xl bg-card/80 p-6 md:p-7 grid gap-6 md:grid-cols-[minmax(0,1fr)_minmax(0,240px)]">
            ...
            <div className="rounded-2xl border border-border bg-background/40 p-4 space-y-3">
              <div className="rounded-xl bg-background/80 border border-border p-3 text-xs">
